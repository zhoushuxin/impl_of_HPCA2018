...
#400.perlbench
perlbench = Process()
perlbench.executable =  'perlbench' + arm_suffix
# TEST CMDS
...
#401.bzip2
bzip2 = Process()
bzip2.executable =  'bzip2' + arm_suffix
# TEST CMDS
...
#410.bwaves
bwaves = Process()
bwaves.executable = 'bwaves' + arm_suffix
# TEST CMDS
...
#416.gamess
gamess=Process()
gamess.executable = 'gamess' + arm_suffix
# TEST CMDS
...
#433.milc
milc=Process()
milc.executable = 'milc' + arm_suffix
# TEST CMDS
...
#434.zeusmp
zeusmp=Process()
zeusmp.executable = 'zeusmp' + arm_suffix
# TEST CMDS
...
#435.gromacs
gromacs = Process()
gromacs.executable = 'gromacs' + arm_suffix
# TEST CMDS
...
#436.cactusADM
cactusADM = Process()
cactusADM.executable = 'cactusADM' + arm_suffix 
# TEST CMDS
...
#437.leslie3d
leslie3d=Process()
leslie3d.executable = 'leslie3d' + arm_suffix
# TEST CMDS
...
#445.gobmk
gobmk=Process()
gobmk.executable = 'gobmk' + arm_suffix
# TEST CMDS
...
####### NOT WORKING #########
dealII=Process()
dealII.executable = 'dealII' + arm_suffix
# TEST CMDS
####### NOT WORKING #########
...
#450.soplex
soplex=Process()
soplex.executable = 'soplex' + arm_suffix
# TEST CMDS
...
#453.povray
povray=Process()
povray.executable = 'povray' + arm_suffix
# TEST CMDS
...
#454.calculix
calculix=Process()
calculix.executable = 'calculix' + arm_suffix
# TEST CMDS
...
#458.sjeng
sjeng=Process()
sjeng.executable = 'sjeng' + arm_suffix 
# TEST CMDS
...
#459.GemsFDTD
GemsFDTD=Process()
GemsFDTD.executable = 'GemsFDTD' + arm_suffix 
# TEST CMDS
...
#462.libquantum
libquantum=Process()
libquantum.executable = 'libquantum' + arm_suffix
# TEST CMDS
...
#464.h264ref
h264ref=Process()
h264ref.executable = 'h264ref' + arm_suffix
# TEST CMDS
...
#465.tonto
tonto=Process()
tonto.executable = 'tonto' + arm_suffix
# TEST CMDS
...
#471.omnetpp
omnetpp=Process()
omnetpp.executable = 'omnetpp' + arm_suffix 
# TEST CMDS
...
#473.astar
astar=Process()
astar.executable = 'astar' + arm_suffix
# TEST CMDS
...
#482.sphinx3
sphinx3=Process()
sphinx3.executable = 'sphinx_livepretend' + arm_suffix 
# TEST CMDS
...
######## NOT WORKING ###########
xalancbmk=Process()
xalancbmk.executable = 'xalancbmk' + arm_suffix
# TEST CMDS
######## NOT WORKING ###########
...
#998.specrand
specrand_i=Process()
specrand_i.executable = 'specrand' + arm_suffix
# TEST CMDS
...
#999.specrand
specrand_f=Process()
specrand_f.executable = 'specrand' + arm_suffix
# TEST CMDS
